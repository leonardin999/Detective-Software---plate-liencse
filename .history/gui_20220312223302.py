...
class MainGUI(QMainWindow):
    def __init__(self):
        ...
        self.ui.BlurValue.valueChanged['int'].connect(lambda: UI_Function.brightness_value(self,self.ui.BlurValue.value()))
        self.ui.BrightValue.valueChanged['int'].connect(lambda: UI_Function.blur_value(self,self.ui.BrightValue.value()))
