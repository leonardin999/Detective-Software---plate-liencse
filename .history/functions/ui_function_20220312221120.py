...
class UI_Function(MainGUI):
    ...
    def update(self):
        ...
        img = ps.putBText(img,text,text_offset_x=100,text_offset_y=425,vspace=20,hspace=10, font_scale=1,background_RGB=(20,210,4),text_RGB=(255,255,255))
        text  =  f'Blur: {self.blur_value_now}: '
        img = ps.putBText(img,text,text_offset_x=self.image.shape[1]-180,text_offset_y=425,vspace=20,hspace=10, font_scale=1,background_RGB=(210,20,4),text_RGB=(255,255,255))
