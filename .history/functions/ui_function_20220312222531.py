...
class UI_Function(MainGUI):
    ...
    def update(self):
        ...
        img = ps.putBText(img,text,text_offset_x=self.image.shape[1]-160,text_offset_y=30,vspace=20,hspace=10, font_scale=1,background_RGB=(228,20,222),text_RGB=(255,255,255))
        ...
        img = ps.putBText(img,text,text_offset_x=self.image.shape[1]-160,text_offset_y=450,vspace=20,hspace=10, font_scale=1,background_RGB=(210,20,4),text_RGB=(255,255,255))
