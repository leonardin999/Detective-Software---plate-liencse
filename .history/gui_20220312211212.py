...
from module import UI_Function
class MainGUI(QMainWindow):
    def __init__(self):
        ...
        self.ui.CameraMode.clicked.connect(UI_Function.videoMode(self))
        self.ui.ImageMode.clicked.connect(UI_Function.imageMode(self))
