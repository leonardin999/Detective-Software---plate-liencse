...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.groupBox_2.setGeometry(QRect(540, 190, 321, 121))
        ...
        self.CameraMode.setGeometry(QRect(550, 10, 111, 20))
        self.ImageMode = QRadioButton(self.centralwidget)
        self.ImageMode.setObjectName(u"ImageMode")
        self.ImageMode.setGeometry(QRect(670, 10, 89, 20))
        self.label_2 = QLabel(self.centralwidget)
        self.label_2.setObjectName(u"label_2")
        self.label_2.setGeometry(QRect(790, 349, 71, 31))
        self.widget2 = QWidget(self.centralwidget)
        self.widget2.setObjectName(u"widget2")
        self.widget2.setGeometry(QRect(540, 310, 321, 51))
        self.gridLayout_3 = QGridLayout(self.widget2)
        self.gridLayout_3.setObjectName(u"gridLayout_3")
        self.gridLayout_3.setContentsMargins(0, 0, 0, 0)
        self.btn_save = QPushButton(self.widget2)
        self.btn_save.setObjectName(u"btn_save")

        self.gridLayout_3.addWidget(self.btn_save, 0, 0, 1, 1)

        self.btn_start = QPushButton(self.widget2)
        self.btn_start.setObjectName(u"btn_start")

        self.gridLayout_3.addWidget(self.btn_start, 0, 1, 1, 1)
